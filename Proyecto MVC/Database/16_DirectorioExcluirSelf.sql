-- Excluir al profesional conectado de Médicos / Psicólogos (solo otros usuarios)
USE TrebolDB;
GO
...
BEGIN
    ...
    ;WITH Base AS (
        ...
        WHERE  p.Estado = N'ACTIVO'
          AND  (@ExcluirProfesionalId IS NULL OR p.ProfesionalId <> @ExcluirProfesionalId)
...
PRINT N'Directorio: excluir profesional conectado aplicado.';
GO
