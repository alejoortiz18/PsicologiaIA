...
### Paso 6 — Leer el token del correo
...
> Leer el token o código de activación del cuerpo del correo. Anotarlo para el siguiente paso.
...
### Paso 9 — Admin aprueba al profesional

> Este paso usa el procedimiento de **AprobacionProfesional-Playwright.md**.  
> Después de la aprobación, continuar con el Paso 10.
